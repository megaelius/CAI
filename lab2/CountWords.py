...
if __name__ == '__main__':
    ...
    try:
        ...
        voc = {}
        #Con esta línea devuelve todos los ducumentos en la lista sc.
        sc = scan(client, index=index, query={"query" : {"match_all": {}}})
        for s in sc:
            try:
                tv = client.termvectors(index=index, id=s['_id'], fields=['text'])
                #termvectors es un diccionario con las ocurrencias de una palabra en cada campo de ese texto.
